...
public class ArbolBinarioBusquedaGenerico<V extends Comparable<V>> {
	    ...
	    public void insertarElemento(V value) {
	    	ABB_NodoGenerico<V> nuevoNodo = new ABB_NodoGenerico<V>(value, null, null);
	    ...
	    public V buscarElemento(V value) {
	    	ABB_NodoGenerico<V> aux = raiz;
	    	ABB_NodoGenerico<V> resultado = null;
	    ...
	    public boolean eliminarElemento(V value) {
	        ...
	        while (aux != null) {
	            ...
	            if (aux.getValue().compare(value) == 0) {
	            	ABB_NodoGenerico<V> nodoAEliminar = aux;
	            	...
	            	ABB_NodoGenerico<V> nodoAEliminar = aux.getIzq();
	            	...
	            	ABB_NodoGenerico<V> nodoAEliminar = aux.getDer();
	    ...
	    private void insertarNodo(ABB_NodoGenerico<V> nodo) {
	        if (raiz == null) {
	            raiz = nodo;
	            System.out.println("Inserto la raiz");
	        } else {
	    ...
	    private void recorrerAscendente(ABB_NodoGenerico<V> nodo, ArrayList<V> elementos) {
	        if (nodo != null) {
	    ...
	    private void recorrerDescendente(ABB_NodoGenerico<V> nodo, ArrayList<V> elementos) {
	        if (nodo != null) {
	            if (nodo.getIzq() == null && nodo.getDer() == null) {
	                elementos.add(nodo.getValue());
	            } else {
